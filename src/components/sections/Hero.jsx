  ...
  return <section className="personal-hero" aria-labelledby="personal-title">
    <div className="container"><div className="personal-hero__panel">
      <div className="personal-hero__copy">
        ...
        <div className="personal-hero__actions"><button type="button" className="btn btn-blue btn-large" onClick={() => scrollToSection('.case-studies-block')}>My projects <span aria-hidden="true">&#8595;</span></button><a className="btn btn-large personal-contact" href="/contact">Let's Talk <span aria-hidden="true">&#8599;</span></a></div>
        <div className="personal-hero__socials" aria-label="Social profiles">
      ...
      <div className="personal-hero__portrait"><img src="/assets/profile/Dan.png" alt="Dan, senior full-stack engineer" fetchPriority="high" /><div className="personal-hero__caption">ENGINEERING WITH PURPOSE<span>From architecture to production.</span></div></div>
    </div></div>
  </section>;
}
