    ...
    <div className="container">
      ...
      <div className="personal-about__grid">
        ...
        <aside className="personal-facts" aria-label="About Daniel">
          <dl>
            <div><dt>Based in</dt><dd>Philadelphia, PA</dd></div>
