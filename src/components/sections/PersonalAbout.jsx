...
const experience = [
  ...
  { company: 'JPMorganChase', role: 'Web Developer', dates: 'July 2015 - November 2016', description: 'Developed REST APIs, a PHP EDI library, SOAP integrations, and browser interfaces. Connected customer and retailer workflows and implemented MapQuest integrations.', tags: 'PHP / CodeIgniter / REST / JavaScript' },
  { company: 'Elsevier', role: 'SCRUM Master', dates: 'October 2011 - January 2012', description: 'Combined software development with Scrum facilitation and Agile delivery practices.', tags: 'Scrum / Agile / Software development' },
];
