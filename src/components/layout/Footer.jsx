  ...
  return <footer className="personal-footer">
    <div className="container">
      <div className="personal-footer__main">
        <div className="personal-footer__intro"><Link href="/" className="personal-footer__brand" aria-label="Dan home">DAN<span>.</span></Link><p>Full-stack engineering. Practical AI.<br />Software built with care.</p><span className="personal-footer__location">Washington Township, NJ</span></div>
