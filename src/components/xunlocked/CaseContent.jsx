...
<div className={"wp-block-group card-content is-layout-flow wp-block-group-is-layout-flow"}><blockquote className={"wp-block-quote card-quote is-layout-flow wp-block-quote-is-layout-flow"}><p className={"wp-block-paragraph"}>{"“Choosing to work with Dan has been a game-changing decision for the progress of our platform. Together the people at xUnlocked and Dan have become one big team, even a family. As CTO, it’s essential for me to have both a technically skilled and culturally integrated team, and Dan has delivered the best. Dan has a great personal attitude and in-depth expertise. With help of Dan, it has allowed us to build and customize our platform fast and easily.”"}</p>
</blockquote>
