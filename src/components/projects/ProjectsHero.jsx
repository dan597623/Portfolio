...
export default function ProjectsHero() {
  return <section className="projects-banner" aria-labelledby="projects-title"><div className="container"><div className="projects-banner__panel projects-banner__panel--photo">
    <Image width={1641} height={958} sizes="100vw" priority className="projects-banner__photo" src="/assets/projects/dan-workspace.png" alt="Daniel working at his development workstation" fetchPriority="high" />
